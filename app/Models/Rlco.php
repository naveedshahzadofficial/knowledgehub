...
class Rlco extends Model
{
    ...
    protected $fillable = ['rlco_no', 'rlco_name', 'description', 'department_id', 'business_category_id', 'business_activity_id',
        ...
        'renewal_fee_plan', 'renewal_fee_schedule', 'fee_manual_mode', 'last_updated_date', 'payment_after_assessment', 'is_fee_required_time_of_application', 'is_verified'];
    ...
    public function rlcoFeeTypes()
    {
        return $this->hasMany(RlcoFeeType::class);
    }
}
