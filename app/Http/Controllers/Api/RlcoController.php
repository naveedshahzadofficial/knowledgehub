...
class RlcoController extends Controller
{
    ...
    public function activities()
    {
        ...
        $categories = BusinessCategoryResource::collection(BusinessCategory::active()->orderBy('sort_order','asc')->get());
    ...
    {
        $business_categories = BusinessCategoryResource::collection(BusinessCategory::active()->orderBy('sort_order','asc')->get());
