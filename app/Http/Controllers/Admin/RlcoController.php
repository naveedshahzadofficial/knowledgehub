        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function(Rlco $rlco){
                ...
                if(!auth()->user()->isDepartment() && !auth()->user()->isSectoralMapper()) {
                    ...
                    $actionBtn .= '&nbsp;&nbsp;<a  href="' . route('admin.rlcos.rlco-variable-fees.index', $rlco) . '" class="edit btn btn-custom-color text-center btn-circle btn-icon btn-xs" title="Variable Fee"><i class="fas fa-money-bill text-white"></i></a>';
                }
