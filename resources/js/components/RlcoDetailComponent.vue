                        ...
                        >
                            ...
                            <td class="text-center"><span v-if="document.document_type.indexOf('Original') !== -1">
                                <span class="svg-icon svg-icon-success svg-icon-2x">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#00aa55" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"/>
                                            <circle fill="#000c60" opacity="0.3" cx="12" cy="12" r="10"/>
                                ...
                                <span v-if="document.document_type.indexOf('Original') == -1">
                                    <span class="svg-icon svg-icon-danger svg-icon-2x">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                                <circle fill="#d5d7df" opacity="0.3" cx="12" cy="12" r="10"/>
