<template>
    <form @submit.prevent="onSubmit" class="search-form">
                ...
                <div class="row search-box">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <button type="submit" class="btn btn-sm px-5 mt-4 text-light search-btn" :class="{'btn-loading': isLoading}">Search</button>&nbsp;&nbsp;
                        <button type="button" class="btn btn-sm px-4 mt-4 text-light search-reset-btn" :class="{'btn-loading': isLoading}" @click.prevent="resetSearch">Reset</button>
                    </div>
