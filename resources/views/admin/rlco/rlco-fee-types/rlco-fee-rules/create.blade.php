            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Add Rlco Fee Rules ({{ $rlco->rlco_name }} - {{ $rlcoFeeType->name }})</h3>
                    </div>
                </div>

                <div class="card-body p-0">
                    {{ Form::open(array('route' => ['admin.rlcos.rlco-fee-types.rlco-fee-rules.store', [$rlco, $rlcoFeeType]],'class'=>'form form-horizontal','name'=>'from','id'=>'from', 'files'=>true)) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('calculation_type')=='rate_based')checked="checked"@endif name="calculation_type" value="rate_based">
                                    <span></span>Rate Based</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('calculation_type')=='fixed_fee')checked="checked"@endif name="calculation_type" value="fixed_fee">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('rate') is-invalid @enderror" name="rate" value="{{ old('rate') }}" id="rate"   />
                            @error('rate')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('minimum_fee') is-invalid @enderror" name="minimum_fee" value="{{ old('minimum_fee') }}" id="minimum_fee"   />
                            @error('minimum_fee')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('unit') is-invalid @enderror" name="unit" value="{{ old('unit') }}" id="unit"   />
                            @error('unit')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('unit') is-invalid @enderror" name="percentage" value="{{ old('percentage') }}" id="percentage"   />
                            @error('percentage')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('processing_fee') is-invalid @enderror" name="processing_fee" value="{{ old('processing_fee') }}" id="processing_fee"   />
                        ...
                        <div class="form-actions p-t-15">
                            <div class="row">
                                <div class="col-xl-offset-3 col-xl-9">
                                    ...
                                    <a class="btn btn-default" href="{{route('admin.rlcos.rlco-fee-types.rlco-fee-rules.index', [$rlco,$rlcoFeeType])}}">Cancel</a>
                                </div>
                            </div>
