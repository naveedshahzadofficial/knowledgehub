            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Update Variable Fee ({{ $rlco->rlco_name }} - {{ $rlcoFeeType->name }} - {{ $rlcoFeeRule->category }})</h3>
                    </div>
                </div>

                <div class="card-body p-0">
                    {{ Form::open(array('route' => ['admin.rlcos.rlco-fee-types.rlco-fee-rules.rlco-user-inputs.update',[$rlco, $rlcoFeeType, $rlcoFeeRule, $rlcoUserInput]],'method'=>'PUT','class'=>'form form-horizontal','name'=>'form','id'=>'form', 'files'=>true)) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('input_name') is-invalid @enderror" name="input_name"
                                   value="{{ old('input_name',$rlcoUserInput->input_name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('input_label') is-invalid @enderror" name="input_label" value="{{ old('input_label',$rlcoUserInput->input_label) }}" id="input_label"   />
                            @error('input_label')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('input_type',$rlcoUserInput->input_type)=='text')checked="checked"@endif name="input_type" value="text">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('validation_rules') is-invalid @enderror" name="validation_rules" value="{{ old('validation_rules',$rlcoUserInput->validation_rules) }}" id="validation_rules"   />
        ...
        $(document).ready(function() {
            ...
            $('#from').validate({
                ...
                rules: {
                    rlco_fee_rule_id: {
                        required: true,
                        digits: true // Ensures only integers are allowed
                    },
                    input_name: {
                        required: true,
                        maxlength: 255
