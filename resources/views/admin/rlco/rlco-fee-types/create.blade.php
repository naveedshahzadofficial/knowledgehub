                ...
                <div class="card-body p-0">
                    ...
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('calculation_period') is-invalid @enderror" name="calculation_period" value="{{ old('calculation_period') }}" id="calculation_period"   />
