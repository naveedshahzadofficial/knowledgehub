        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom ">
                ...
                <div class="card-body p-0">
                    {{ Form::open(array('route' => ['admin.rlcos.rlco-fee-types.update',[$rlco, $rlcoFeeType]],'method'=>'PUT','class'=>'form form-horizontal','name'=>'form','id'=>'form', 'files'=>true)) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('name') is-invalid @enderror" name="name"
                                   value="{{ old('name', $rlcoFeeType->name) }}"
                                   id="name"  required />
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('description') is-invalid @enderror" name="description" value="{{ old('description', $rlcoFeeType->description) }}" id="description"   />
                            @error('description')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('order') is-invalid @enderror" name="order" value="{{ old('order', $rlcoFeeType->order) }}" id="order"  required />
                            @error('order')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('status', $rlcoFeeType->status)=='1')checked="checked"@endif name="status" value="1">
                                    <span></span>Active</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('status', $rlcoFeeType->status)=='0')checked="checked"@endif name="status" value="0">
