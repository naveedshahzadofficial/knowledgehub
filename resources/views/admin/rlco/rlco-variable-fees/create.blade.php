        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom ">
                ...
                <div class="card-body p-0">
                    {{ Form::open(array('route' => ['admin.rlcos.rlco-variable-fees.store', $rlco],'class'=>'form form-horizontal','name'=>'from','id'=>'from', 'files'=>true)) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('unit') is-invalid @enderror" name="unit" value="{{ old('unit') }}" id="unit"   />
                            @error('unit')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('unit_quantity') is-invalid @enderror" name="unit_quantity" value="{{ old('unit_quantity') }}" id="unit_quantity"   />
                            @error('unit_quantity')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" id="price" required />
                            @error('price')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
