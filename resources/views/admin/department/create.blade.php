            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Add Department</h3>
                    </div>
                </div>

                <div class="card-body p-0">
                    {{ Form::open(array('route' => 'admin.departments.store','class'=>'form form-horizontal','name'=>'department_form','id'=>'department_form')) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('department_display_name') is-invalid @enderror" name="department_display_name"
                                   value="{{ old('department_display_name') }}"
                        ...
                        <div class="form-group">
                            ...
                            @foreach($scopes as $scope)
                                    <label class="radio radio-success">
                                        <input type="radio"  @if(old('department_scope')==$scope->scope_title)checked="checked"@endif name="department_scope" value="{{ $scope->scope_title }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="department_remark" class="form-control @error('department_remark') is-invalid @enderror" rows="2">{{ old('department_remark') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('department_status')=='1')checked="checked"@endif name="department_status" value="1">
                                    <span></span>Active</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('department_status')=='0')checked="checked"@endif name="department_status" value="0">
