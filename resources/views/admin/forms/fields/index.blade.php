            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">All Form Fields ({{ $form->form_name }})</h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('admin.forms.form-fields.create', $form) }}" class="btn btn-custom-color font-weight-bolder">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            myDataTable = $('#my_datatable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{{ route('admin.forms.form-fields.index', $form) }}',
                    type: "GET"
                },
                columns: [
                    ...
                    {data: 'field_type', name: 'field_type', class:'text-center'},
                    {data: 'is_required', name: 'is_required', class:'text-center'},
                    {data: 'field_options', name: 'field_options'},
