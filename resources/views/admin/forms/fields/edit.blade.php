                ...
                <div class="card-body p-0">
                    ...
                    <div class="form-body col-xl-8 col-xs-12">
                            ...
                            <select name="form_table_row_id" class="form-control select2  @error('form_table_row_id') is-invalid @enderror" required>
                                ...
                                @isset($form_table_rows)
                                    @foreach($form_table_rows as $form_table_row)
                                        <option value="{{ $form_table_row->id }}"  @if(old('form_table_row_id', $formField->form_table_row_id) == $form_table_row->id) selected @endif >{{ $form_table_row->row_name }}</option>
                                    @endforeach
                                @endisset
                            </select>
                            ...
                            <select name="form_table_column_id" class="form-control select2  @error('form_table_column_id') is-invalid @enderror" required>
                                ...
                                @isset($form_table_columns)
                                    @foreach($form_table_columns as $form_table_column)
                                        <option value="{{ $form_table_column->id }}" @if(old('form_table_column_id', $formField->form_table_column_id) == $form_table_column->id) selected @endif >{{ $form_table_column->column_name }}</option>
                                    @endforeach
                                @endisset
                            </select>
                        ...
                        <div class="form-group conditional-group" id="date-type-group" style="display: none;">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('date_type', $formField->date_type)=='1')checked="checked"@endif name="date_type" value="1">
                                    <span></span>Date Only</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('date_type', $formField->date_type)=='2')checked="checked"@endif name="date_type" value="2">
                                    <span></span>Year Only</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('date_type', $formField->date_type)=='3')checked="checked"@endif name="date_type" value="3">
                                    <span></span>Time Only</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('date_type', $formField->date_type)=='4')checked="checked"@endif name="date_type" value="4">
                        ...
                        <div class="form-group conditional-group" id="max-date-group" style="display: none;">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('max_date', $formField->max_date)=='1')checked="checked"@endif name="max_date" value="1">
                                    <span></span>Future Date</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('max_date', $formField->max_date)=='2')checked="checked"@endif name="max_date" value="2">
