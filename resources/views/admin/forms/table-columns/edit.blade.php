...
@push('title','Update Form Table Column')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom ">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Update Form Table Column ({{ $form->form_name }})</h3>
                    </div>
                </div>

                <div class="card-body p-0">
                    {{ Form::open(array('route' => ['admin.forms.form-table-columns.update', [$form, $formTableColumn]], 'method'=>'PUT', 'class'=>'form form-horizontal','name'=>'from','id'=>'from', 'files'=>true)) }}
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('column_name') is-invalid @enderror" name="column_name"
                                   value="{{ old('column_name', $formTableColumn->column_name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="255" type="text" class="form-control  @error('column_order') is-invalid @enderror" name="column_order"
                                   value="{{ old('column_order', $formTableColumn->column_order) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('column_status', $formTableColumn->column_status)=='1')checked="checked"@endif name="column_status" value="1">
                                    <span></span>Active</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('column_status', $formTableColumn->column_status)=='0')checked="checked"@endif name="column_status" value="0">
