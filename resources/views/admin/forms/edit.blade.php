            ...
            <div class="card card-custom ">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="form-body col-xl-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('is_tabular', $form->is_tabular)=='1')checked="checked"@endif name="is_tabular" value="1">
                                    <span></span>Yes</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('is_tabular', $form->is_tabular)=='0')checked="checked"@endif name="is_tabular" value="0">
                                    <span></span>No</label>
                            </div>
                            @error('is_tabular')
                        ...
                        <div class="form-group" id="is-add-more-section" @if(old('is_tabular', $form->is_tabular)=='0') style="display: none;" @endif>
                            <label for="is_add_more">Add More</label>
                            <div class="radio-inline">
                                <label class="radio radio-success">
                                    <input type="radio"  @if(old('is_add_more', $form->is_add_more)=='1')checked="checked"@endif name="is_add_more" value="1">
                                    <span></span>Yes</label>

                                <label class="radio radio-danger">
                                    <input type="radio"  @if(old('is_add_more', $form->is_add_more)=='0')checked="checked"@endif name="is_add_more" value="0">
                                    <span></span>No</label>
                            </div>
                            @error('is_add_more')
                            <div class="invalid-feedback d-block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('form_sub_heading') is-invalid @enderror" name="form_sub_heading"
                                   value="{{ old('form_sub_heading', $form->form_sub_heading) }}"
                                   id="form_sub_heading"  />
